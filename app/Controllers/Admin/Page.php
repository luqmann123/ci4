...
class Page extends BaseController
{
    function __construct()
    {
        ...
        $this->halaman_controller = "page"; // Changed from "dashboard"
        $this->halaman_label = "Page"; // Changed from "Dashboard"
    }
    ...
    function index()
    {
        ...
        if ($this->request->getVar('aksi') == 'hapus' && $this->request->getVar('post_id')) {
            // Code for delete action here
        }

        // Initialize template title and search keyword
